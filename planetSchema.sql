...
INSERT INTO planet (name, image, general_environment, day_length, random1, random2)
VALUES ('NEPTUNE', '/styles/images/neptune.jpg', 'Neptune is an ice giant. Most of its mass is a hot, dense fluid of icy materials – water, methane and ammonia – above a small rocky core. Neptune''s atmosphere is made up mostly of molecular hydrogen, atomic helium and methane.', 'It takes 60,190 Earth days for Neptune.', 'Neptune has 13 moons (and one more awaiting confirmation of discovery), which are named after sea gods and nymphs in Greek mythology.', 'Neptune is about four times wider than Earth. If Earth were a large apple, Neptune would be the size of a basketball.');
